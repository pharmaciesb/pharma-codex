...
(function () {
  const BreadcrumbManager = {
    _currentRoute: null, // ✅ Stocker la route actuelle
    
    updateBreadcrumb(route) {

      // ✅ Éviter de mettre à jour si même route
      if (this._currentRoute === route) {
        console.log('[Breadcrumb] Route identique, skip update');
        return;
      }

      this._currentRoute = route; // ✅ Mettre à jour la route actuelle
    ...
    // ✅ Réinitialiser le cache lors de changement de route
    reset() {
